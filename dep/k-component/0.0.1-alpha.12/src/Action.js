...
define(function (require) {
    ...
    function Action(opts) {
         ...
         * @method trigger
         */
        me.trigger = _.bind(me.el.trigger, me.el);
         ...
         */
        me.triggerHandler = _.bind(me.el.triggerHandler, me.el);
