...
<html lang="en">
<head>
    <title>Code coverage report for edp-build/lib/processor/string-replace.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">edp-build/lib/processor/string-replace.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">edp-build/lib/processor/</a> &#187; string-replace.js</div>
</div>
<div class="body">
...
StringReplace.prototype.process = function (file, processContext, callback) {
    ...
    this.replacements.forEach(function (replacement) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (from != null &amp;&amp; to != null) {
