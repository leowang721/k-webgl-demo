...
<html lang="en">
<head>
    <title>Code coverage report for edp-build/lib/processor/html-minifier.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">edp-build/lib/processor/html-minifier.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">edp-build/lib/processor/</a> &#187; html-minifier.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    var minifyOptions = edp.util.extend(
        ...
        this.minifyOptions || <span class="branch-1 cbranch-no" title="branch not covered" >{}</span>
    );
&nbsp;
    try {
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        edp.log.fatal('minify html failed, file = [%s], msg = [%s]',</span>
