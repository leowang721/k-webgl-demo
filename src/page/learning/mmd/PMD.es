...
export function PMDMaterial(id) {
  this.id = id;
  this.color = null;
...
export function PMDFaceVertex(id, type) {
  this.id = id;
  this.type = type;
  this.index = null;
  this.position = null;
...
export function PMDFaceDisplay(id) {
  this.id = id;
  this.index = null;
};
...
export function PMDBoneFrameName(id) {
  this.id = id;
  this.name = null;
};
...
export function PMDBoneDisplay(id) {
  this.id = id;
  this.index = null;
...
export function PMDEnglishHeader() {
...
export function PMDEnglishBoneName(id) {
  this.id = id;
  this.name = null;
};
...
export function PMDEnglishFaceName(id) {
  this.id = id;
  this.name = null;
};
...
export function PMDEnglishBoneFrameName(id) {
  this.id = id;
  this.name = null;
};
...
export function PMDToonTexture(id) {
  this.id = id;
  this.fileName = null;
};
...
export function PMDRigidBody(id) {
  this.id = id;
  this.name = null;
  this.boneIndex = null;
...
export function PMDImageLoader(pmd, baseURL) {
  this.pmd = pmd;
